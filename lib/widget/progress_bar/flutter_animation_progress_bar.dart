    ...
    return Directionality(
      ...
      child: Container(
        ...
        child: Flex(
          ...
          children: <Widget>[
            Expanded(
                flex: (((animation.value < 0.2 && animation.value > 0) ? 0.2 : animation.value) * 100).toInt(),
                child: Stack(children: progressWidgets)),
            Expanded(
                flex: 100 - (((animation.value < 0.2 && animation.value > 0) ? 0.2 : animation.value) * 100).toInt(), child: Container())
          ],
        ),
      ),
    );
